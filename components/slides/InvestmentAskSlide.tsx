...
export default function InvestmentAskSlide() {
  return (
    <div className="relative w-full h-full overflow-hidden bg-gradient-to-br from-white via-binti-purple/5 to-binti-cyan/5">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-12 py-8 w-full h-full flex flex-col">
        ...
        >
          <h2 className="text-3xl font-bold mb-2 bg-gradient-to-r from-binti-purple to-binti-magenta bg-clip-text text-transparent">
            Investment Opportunity
          </h2>
          <p className="text-base text-gray-700">Join us in revolutionizing women&apos;s health</p>
        </motion.div>
