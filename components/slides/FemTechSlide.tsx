...
export default function FemTechSlide() {
  return (
    <div className="relative w-full h-full flex items-center overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-12 py-8 w-full h-full flex flex-col justify-center">
        <motion.h2
        ...
        <div className="space-y-4">
          ...
          >
            <div className="flex items-baseline gap-3">
              ...
              <span className="text-xl text-gray-700">$40B feminine hygiene, $309B fem-tech by 2022.</span>
            </div>
          </motion.div>
